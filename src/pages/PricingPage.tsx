...
const PLAN_CARDS: PlanCard[] = [
  {
    ...
    featureBullets: [
      ...
      { icon: Map, label: '1 technical rider & stage plot' },
      { icon: NotebookPen, label: '1 setlist' },
      { icon: Share2, label: '1 press kit' },
  ...
  },
  {
    ...
    featureBullets: [
      ...
      { icon: NotebookPen, label: 'Unlimited setlists & concert mode' },
      { icon: Link2, label: 'Unlimited technical riders' },
      { icon: Share2, label: 'Unlimited press kits' },
