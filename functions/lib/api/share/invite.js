...
const onRequestPost = async (ctx) => {
    ...
    const invites = await (0, firebase_admin_1.listFirestoreDocuments)(ctx.env, ['collaborationInvites']);
    ...
    await (0, firebase_admin_1.setFirestoreDocument)(ctx.env, ['collaborationInvites', inviteId], {
        ownerId: userId,
        ownerEmail,
        recipientEmail,
